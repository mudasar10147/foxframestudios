...
export const aboutContent = {
  ...
  description:
    "I'm Fynix Dev, owner of FoxDevs Studio. I work with Roblox developers and studios across the full production pipeline — interface design, Luau scripting, map building, and 3D modelling.",
  paragraphs: [
...
export const projects: Project[] = [
  ...
  // Neon Action UI — a Roblox rewards and inventory interface set.
  {
    id: "neon-02",
