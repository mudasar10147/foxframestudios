...
export const projects: Project[] = [
  ...
  {
    id: "stud-ui-08",
    slug: "garden-simulator-interface",
    title: "Garden Simulator Interface",
    role: "Made By Cecle DEV",
    summary:
      "A complete stud-style farming game interface covering the top bar, shop perks, rebirth requirements, plant inventory, index, and build action bar.",
    stack: ["Roblox UI", "Simulator UI", "Stud Style"],
    category: "ui-designs",
    subcategory: "UI Kit",
    set: "Stud UI",
    cover: "/work/stud-ui/garden-simulator-interface.png",
    featured: false,
    year: 2026,
  },
  {
    id: "stud-ui-09",
    slug: "garden-settings",
    title: "Garden Settings",
    role: "Made By Cecle DEV",
    summary:
      "A bold stud-style settings panel with clear icon-led controls for music, sound effects, notifications, and visual detail.",
    stack: ["Roblox UI", "Settings", "Stud Style"],
    category: "ui-designs",
    subcategory: "Settings",
    set: "Stud UI",
    cover: "/work/stud-ui/garden-settings.png",
    featured: false,
    year: 2026,
  },
  {
    id: "stud-ui-10",
    slug: "garden-daily-rewards",
    title: "Garden Daily Rewards",
    role: "Made By Cecle DEV",
    summary:
      "A seven-day daily rewards screen with colourful reward cards, claimed states, milestone gifts, and a prominent claim action.",
    stack: ["Roblox UI", "Retention", "Stud Style"],
    category: "ui-designs",
    subcategory: "Daily Rewards",
    set: "Stud UI",
    cover: "/work/stud-ui/garden-daily-rewards.png",
    featured: false,
    year: 2026,
  },
  {
    id: "stud-ui-11",
    slug: "rebirth-card-states",
    title: "Rebirth Card States",
    role: "Made By Cecle DEV",
    summary:
      "A state study for a rebirth reward card, showing its normal, hover, and locked variants with clear visual feedback.",
    stack: ["Roblox UI", "Interaction States", "Stud Style"],
    category: "ui-designs",
    subcategory: "Rebirth",
    set: "Stud UI",
    cover: "/work/stud-ui/rebirth-card-states.png",
    featured: false,
    year: 2026,
  },
  {
    id: "stud-ui-12",
    slug: "garden-boost-shop",
    title: "Garden Boost Shop",
    role: "Made By Cecle DEV",
    summary:
      "A colourful stud-style boost shop with category tabs, item cards, clear pricing, and a focused purchase action.",
    stack: ["Roblox UI", "Shop UI", "Stud Style"],
    category: "ui-designs",
    subcategory: "Shop",
    set: "Stud UI",
    cover: "/work/stud-ui/garden-boost-shop.png",
    featured: false,
    year: 2026,
  },
  ...
  {
    id: "spaceship-01",
    slug: "futuristic-landing-craft",
    title: "Futuristic Landing Craft",
    role: "3D Modeller",
    summary:
      "A dark sci-fi landing craft with an angular armoured hull, illuminated window panels, and orange accent lights that define its compact silhouette.",
    cover: "/work/spaceships/futuristic-landing-craft.png",
    stack: ["Spaceship Design", "Hard-Surface", "Materials"],
    category: "3d-modelling",
    subcategory: "Spaceship",
    set: "Vehicles & Spaceships",
    featured: false,
  ...
  {
    id: "spaceship-02",
    slug: "landing-gear-detail",
    title: "Landing Gear Detail",
    role: "3D Modeller",
    summary:
      "A close technical view of the craft’s landing gear and boarding ramp, showcasing the mechanical supports, undercarriage panels, and access design.",
    cover: "/work/spaceships/landing-gear-detail.png",
    stack: ["Spaceship Design", "Hard-Surface", "Detailing"],
    category: "3d-modelling",
    subcategory: "Spaceship",
    set: "Vehicles & Spaceships",
    featured: false,
  ...
  {
    id: "spaceship-03",
    slug: "starship-interior",
    title: "Starship Interior",
    role: "3D Modeller",
    summary:
      "A functional spacecraft interior with layered wall panels, guide lighting, storage details, and a central passage that leads towards the cockpit.",
    cover: "/work/spaceships/starship-interior.png",
    stack: ["Spaceship Design", "Interior Design", "Lighting"],
    category: "3d-modelling",
    subcategory: "Spaceship",
    set: "Vehicles & Spaceships",
    featured: false,
  ...
  {
    id: "spaceship-04",
    slug: "futuristic-landing-craft-rear",
    title: "Futuristic Landing Craft — Rear",
    role: "3D Modeller",
    summary:
      "A rear three-quarter render of the landing craft, highlighting the wide engine housing, layered tail surfaces, ramp assembly, and glowing side panels.",
    cover: "/work/spaceships/futuristic-landing-craft-rear.png",
    stack: ["Spaceship Design", "Hard-Surface", "Rendering"],
    category: "3d-modelling",
    subcategory: "Spaceship",
    set: "Vehicles & Spaceships",
    featured: false,
