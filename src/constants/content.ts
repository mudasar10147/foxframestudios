...
export const projects: Project[] = [
  ...
  },
  {
    ...
    role: "3D Modeller",
    summary:
      "A playful hybrid character that combines a bright green primate with a peeled banana body. The oversized silhouette and layered fur make the design instantly readable.",
    cover: "/work/brainrot-models/chimpanzini-bananini.png",
    stack: ["3D Modelling", "Stylised Design", "Rendering"],
    category: "3d-modelling",
    subcategory: "BrainRot Model",
    set: "BrainRot Models",
    featured: false,
    year: 2025,
  },
  {
    id: "brainrot-02",
    slug: "fantina-balerina",
    title: "Fantina Balerina",
    role: "3D Modeller",
    summary:
      "A cheerful orange-themed character with sculpted curl hair, a dress, and a matching bottle prop. Smooth materials and rounded proportions give it a collectible toy feel.",
    cover: "/work/brainrot-models/fantina-balerina.png",
    stack: ["3D Modelling", "Stylised Design", "Rendering"],
    category: "3d-modelling",
    subcategory: "BrainRot Model",
    set: "BrainRot Models",
  ...
  },
  {
    ...
    role: "3D Modeller",
    summary:
      "A whimsical cup-headed ballerina with a pink tutu and graceful pose. Soft sculpted details keep the character expressive while preserving a clean, toy-like finish.",
    cover: "/work/brainrot-models/ballerina-cappuccina.png",
    stack: ["3D Modelling", "Character Design", "Rendering"],
    category: "3d-modelling",
    subcategory: "BrainRot Model",
    set: "BrainRot Models",
    featured: false,
  ...
  {
    id: "brainrot-04",
    slug: "tung-tung-tung-tung-sahur",
    title: "Tung Tung Tung Tung Sahur",
    role: "3D Modeller",
    summary:
      "A deliberately simple wooden mascot with large eyes, a friendly expression, and an exaggerated T-pose. Its warm wood material makes the unusual silhouette stand out.",
    cover: "/work/brainrot-models/tung-tung-tung-tung-sahur.png",
    stack: ["3D Modelling", "Character Design", "Materials"],
    category: "3d-modelling",
    subcategory: "BrainRot Model",
    set: "BrainRot Models",
    featured: false,
  ...
  {
    id: "brainrot-05",
    slug: "brr-brr-patapim-q",
    title: "Brr Brr Patapim Q",
    role: "3D Modeller",
    summary:
      "A leafy forest creature built from layered foliage, bark-like limbs, and a distinctive rounded nose. Organic surface detail gives the character a textured storybook presence.",
    cover: "/work/brainrot-models/brr-brr-patapim-q.png",
    stack: ["3D Modelling", "Organic Sculpting", "Texturing"],
    category: "3d-modelling",
    subcategory: "BrainRot Model",
    set: "BrainRot Models",
    featured: false,
  ...
  {
    id: "brainrot-06",
    slug: "bomboclat-crococlat",
    title: "Bomboclat Crococlat",
    role: "3D Modeller",
    summary:
      "A mechanical crocodile concept fitted with radioactive tanks, glowing indicators, and armoured machinery. Organic creature forms and hard-surface components create a striking contrast.",
    cover: "/work/brainrot-models/bomboclat-crococlat.png",
    stack: ["3D Modelling", "Creature Design", "Hard-Surface"],
    category: "3d-modelling",
    subcategory: "BrainRot Model",
    set: "BrainRot Models",
    featured: false,
  ...
  },
  {
    id: "brainrot-07",
    slug: "hospital-kitty",
    title: "Hospital Kitty",
    role: "3D Modeller",
    summary:
      "A block-built black mascot equipped with bold pink-and-red hardware, a glowing heart emblem, and a high-impact silhouette. The sharp colour contrast gives the character a game-ready look.",
    cover: "/work/brainrot-models/hospital-kitty.png",
    stack: ["3D Modelling", "Stylised Design", "Hard-Surface"],
    category: "3d-modelling",
    subcategory: "BrainRot Model",
    set: "BrainRot Models",
    featured: false,
  ...
  {
    id: "brainrot-08",
    slug: "bombombona-pocorona",
    title: "Bombombona Pocorona",
    role: "3D Modeller",
    summary:
      "A surreal sheep-and-warplane hybrid with a detailed aircraft body, engine pods, and a soft woolly character form. The unexpected combination balances realism with playful design.",
    cover: "/work/brainrot-models/bombombona-pocorona.png",
    stack: ["3D Modelling", "Vehicle Design", "Creature Design"],
    category: "3d-modelling",
    subcategory: "BrainRot Model",
    set: "BrainRot Models",
    featured: false,
