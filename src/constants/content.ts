...
export const projects: Project[] = [
  ...
  {
    id: "proj-9",
    slug: "stylised-weapon-pack",
    title: "Stylised Weapon Pack",
    role: "3D Modeller",
    summary:
      "A set of low-poly weapons modelled, UV-unwrapped, and hand-textured to match a stylised art direction, optimised for Roblox import.",
  ...
  {
    id: "proj-10",
    slug: "character-accessory-set",
    title: "Character Accessory Set",
    role: "3D Modeller",
    summary:
      "Rigged hats, backpacks, and gear pieces built to Roblox avatar standards with clean topology and consistent scale.",
    stack: ["Blender", "Roblox Studio"],
    category: "3d-modelling",
